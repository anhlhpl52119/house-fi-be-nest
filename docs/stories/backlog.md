...
US-006 starts `E05 Credit Cards` with pending spending plus generated settlement cash payments. After US-006, the next slice should start `E06 Installments`, because installment plans can reuse the same spending-incurred versus cash-payment separation pattern.
