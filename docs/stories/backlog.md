...
| E02 Households | Household records, household membership, and household-scoped access foundations for business records. | member-management slice implemented by US-003; current-household bootstrap implemented by US-012; household settings implemented by US-013 |
...
| E09 Reports | Derived reports for spending incurred, cash flow, obligations, assets, and savings. | US-010 implemented |
